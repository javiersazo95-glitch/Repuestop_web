...
function HomePage() {
  ...
  return <main className="single-page">
    <section className="home-hero section" id="inicio"><div className="hero-orb orb-one" /><div className="hero-orb orb-two" /><div className="hero-copy"><div className="hero-topline"><Brand /><span className="hero-topline-divider" aria-hidden="true" /><span className="eyebrow hero-eyebrow"><MapPin /> El punto de encuentro para los repuestos</span></div><h1>El repuesto que buscas. La conexión que <em>necesitas.</em></h1><p>RepuesTop conecta personas y tiendas en una experiencia ágil, confiable y creada para una nueva forma de moverse.</p><div className="button-row"><a href="#experiencias" className="button"><Zap /> Descubrir RepuesTop</a><a href="#como-funciona" className="button button-outline">Ver cómo funciona <ArrowDown /></a></div><div className="hero-platforms"><PlatformPill platform="android" /><PlatformPill platform="ios" soon /></div></div><div className="hero-visual"><div className="hero-badge"><span><strong>Compra y vende</strong> en un solo lugar</span></div><div className="image-panel"><img src="/assets/compradores.jpg" alt="Aplicación RepuesTop buscando repuestos por patente en Chile" /></div></div></section>
